...
public class PeliculaService {
    public ArrayList<Pelicula> crearPeliculas(){
        ...
        Pelicula pelicula1 = new Pelicula("Titanic", 3.5 , 16 ,"James Cameron");
        Pelicula pelicula2 = new Pelicula("El Padrino", 3.2 , 16 ,"Scorsse");
        Pelicula pelicula3 = new Pelicula("Bastardos sin Gloria", 2.1 , 18 ,"Tarantino");
        Pelicula pelicula4 = new Pelicula("Super Mario", 1.8 , 6 ,"Pedrido");
        Pelicula pelicula5 = new Pelicula("Estafadores", 2.5 , 12 ,"Juanito");
        
        movieList.add(pelicula1);
        movieList.add(pelicula2);
        movieList.add(pelicula3);
        movieList.add(pelicula4);
